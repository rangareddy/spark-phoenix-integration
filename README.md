...
val zkUrl="c3543-node2.coelab.cloudera.com:2181"
//val zkUrl="c3543-node2.coelab.cloudera.com:2181/hbase-secure"
...
### Step6: Login to hbase shell and check the data in HBase
```sh
hbase shell
...
val zkUrl="c3543-node2.coelab.cloudera.com:2181"
//val zkUrl="c3543-node2.coelab.cloudera.com:2181/hbase-unsecure"
